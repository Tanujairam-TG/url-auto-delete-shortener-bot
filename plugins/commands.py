...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('ႮᏢᎠᎪͲᎬՏ💜', url='https://t.me/OTT_Updated')
            ],
            [
                InlineKeyboardButton('ՏႮᏴՏᏟᎡᏆᏴᎬ 🧡', url=f"https://youtube.com/@rvdhdstatud6503"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('ᎻϴᏔ Ͳϴ ᎠϴᏔΝᏞϴᎪᎠ ᎷϴᏙᏆᎬՏ⭐', url='https://t.me/firstshowers1/6190')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥ᎫϴᏆΝ ႮᏢᎠᎪͲᎬ ᏟᎻᎪΝΝᎬᏞ🔥", url=invite_link.invite_link
                )
            ]
        ]
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('ՏႮᏴՏᏟᎡᏆᏴᎬ🧡', url='https://youtube.com/@GreyMattersYT') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
